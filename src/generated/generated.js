...
function peg$parse(input, options) {
  ...
  var peg$c0 = function(values) { return new ast.Document(widlLocation(), values); };
  ...
  var peg$c13 = function(name) { return new ast.NamespaceDefinition(widlLocation(), name, undefined, annotations() ); };
  ...
  var peg$c26 = function(name, args, type) { return new ast.OperationDefinition(widlLocation(),name, undefined, args, type, annotations(), false); };
  var peg$c27 = peg$otherExpectation("argument");
  var peg$c28 = function(pair) { return new ast.ParameterDefinition(widlLocation(), pair.name, undefined, pair.type, undefined, annotations()); };
  var peg$c29 = peg$otherExpectation("type field");
  var peg$c30 = function(pair) {return new ast.FieldDefinition(widlLocation(), pair.name, undefined, pair.type, undefined, annotations());};
  ...
  var peg$c66 = function(name, type) {return { name, type };};
  var peg$c67 = peg$otherExpectation("map");
  var peg$c68 = function(keyType, valueType) { return new ast.MapType(widlLocation(), keyType, valueType); };
  var peg$c69 = peg$otherExpectation("list");
  var peg$c70 = function(type) {return new ast.ListType(widlLocation(), type);};
  var peg$c71 = peg$otherExpectation("string");
  var peg$c72 = function(chars) { return new ast.StringValue(widlLocation(), chars.join("")); };
  ...
  var peg$c147 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true);
